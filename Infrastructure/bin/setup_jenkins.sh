...
if [ "$#" -ne 3 ]; then
    ...
    echo "  Example: $0 GUID https://github.com/wkulhanek/ParksMap na39.openshift.opentlc.com"
    exit 1
fi
...
oc new-app jenkins-persistent --param ENABLE_OAUTH=true --param MEMORY_LIMIT=4Gi --param VOLUME_CAPACITY=10Gi -n ${GUID}-jenkins
